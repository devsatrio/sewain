            ...
            @endif
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">List Data Kategori Artikel</h3>
                    </div>
        ...
        <div class="col-md-4">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Tambah Data Kategori Artikel</h3>
                </div>
                <form role="form" method="post" action="{{url('kategori-artikel')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
